...
*/
      ...
      drivetrain(0.7, 600, 0.8);
      pros::delay(20);

     turnCounter(90, 2000);

 pros::delay(20);
      drivetrain(-0.9, 2000, 0.6);
 pros::delay(20);

       turnRIGHTONLY(60, 1000);
...
*/
  ...
  turnCounter(43, 2000);
       ...
       // drivetrain(0.6, 2000, 0.6);

 

  drivetrain(7, 2000, 0.6);
...
/*
        drivetrain(-1.4, 900, 1);
        turnLEFTONLY(55, 1000);
        drivetrain(-2, 900, 1.5);
